...
def main():
    ...
    df_vamp = pd.read_csv(f"{data_path}/train/downstream/df_vamp_sep24_v3.csv")
    ...
    for i in range(len(pdbid_list)):
        ...
        for j in range(NUM_ENSEMBLE):
            ...
            dataloader_train_ds, dataloader_train_val_std_ds, dataloader_val_ds = train_val_split_ds_std(
                df_vamp, [pdbid_val], model_idx, BATCH_SIZE_DS, DEVICE, MinMaxScaler(),
                feature_norm_individual_list, feature_norm_global_list
            )
            ...
            use_pretrained_ds_model = False
            std_train = False
            
            ds_std_train_val(
                dataloader_train_ds,
                dataloader_train_val_std_ds,
                dataloader_val_ds,
                ds_model_input_size,
            ...
            print("Training downstream network and standard curves models")

            use_pretrained_ds_model = True
            std_train = True
